            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-ourgallery">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('galleries.index') }}"><i data-feather="minus"></i> Manage</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <!-- Products Section -->
                        <li>
                            <a href="#sidebar-categoris" data-bs-toggle="collapse">
                                <i data-feather="database"></i>
                                <span> Products </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-categoris">
                                <ul class="nav-second-level">
                                <li>
                                        <a href="{{ route('products.index') }}"><i data-feather="minus"></i> Product manage</a>
                                    </li>
                               
                                    <li>
                                        <a href="{{ route('category.index') }}"><i data-feather="minus"></i> Categoris</a>
                                    </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-sitesetting">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('license.index') }}"><i data-feather="minus"></i>
                                            License</a>
                                    </li>
                                    <li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 text-end">&copy; {{ $generalsetting->name }} <a
                                href="https://www.insideit.com.bd/" target="_blank">Inside IT</a></div>
                    </div>
                </div>
            </footer>
            <!-- end Footer -->
