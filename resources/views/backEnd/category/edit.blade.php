    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('category.index') }}" class="btn btn-primary rounded-pill">Manage</a>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('category.update') }}" method="POST" class="row"
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control @error('image') is-invalid @enderror "
                                        name="image"  id="image" value="{{$edit_data->image }}" >
